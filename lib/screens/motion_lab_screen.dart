// Full-screen embedded Unity Motion Lab (ห้องทดลองท่าทาง — camera test range).
//
...
// ("motionlab") once the player is ready (and again on every unity_ready,
...
class _MotionLabScreenState extends State<MotionLabScreen> {
  ...
  void _selectGame() => sendToUnity('SceneRouter', 'LoadGame', 'motionlab');
  ...
  Widget build(BuildContext context) {
    ...
    // Full-screen embedded Unity test range (no app bar). Camera permission is
    // required because the whole page exists to test the live MediaPipe feed.
    return Scaffold(
